...
<body>
    <?php
       /* try{
        ...
        $reponse = $bdd->query('SELECT L.name_langage, P.* from Langage L inner join Post P on L.id_langage = P.id_langega where L.id_langage = 2;');
    ...
    ?>
        <?php include "header.html"; ?>
            <ul class="s">
                ...
                <li><a href="css3.php" class="css3-bouton2"><i class="fab fa-css3-alt"></i></a></li>
