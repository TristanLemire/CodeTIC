...
<body>
    <?php
       /* try{
        ...
        $reponse = $bdd->query('SELECT L.name_langage, P.* from Langage L inner join Post P on L.id_langage = P.id_langega where L.id_langage = 4;');
    ...
    ?>
        <?php include "header.html"; ?>
            <ul class="s">
                ...
                <li><a href="php5.php" class="php5-bouton2"><i class="fab fa-php"></i></a></li>
